...
namespace pandoCommons {
    ...
    public class Discord_ThemeContainer : ContainerControl {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(35, 39, 42)), new Rectangle(0, 0, Width, 20));
    ...
    public class Discord_ControlBox : Control {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if (_EnableHoverHighlight == true) {
                switch (ButtonHState) {
                    ...
                    case ButtonHoverState.Minimize:
                        if (_EnableMinimize == true) {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(35, 39, 42)), new Rectangle(3, 0, 30, Height));
                        }
                        break;
                    case ButtonHoverState.Maximize:
                        if (_EnableMaximize == true) {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(35, 39, 42)), new Rectangle(35, 0, 30, Height));
                        }
                        break;
                    case ButtonHoverState.Close:
                        G.FillRectangle(new SolidBrush(Color.FromArgb(35, 39, 42)), new Rectangle(66, 0, 35, Height));
                        break;
                }
            }
    ...
    public class Discord_Menu_Button : Control {
        ...
        public bool DisableColoration { get; set; } = false;
        ...
        private void drawGBP(Graphics G, PointF ipt,
            ...
            Color c = Toggleable ?
                (Toggled ? Color.White : ForeColor) :
                (MouseState == 1 ? Color.White : ForeColor);
